import Icon, { IconNames } from "../Icon/index.js";
...
const getIcon = (intent: IntentType) => {
  switch (intent) {
    case "info":
      return IconNames.InfoSign;
    case "success":
      return IconNames.TickCircle;
    case "warning":
      return IconNames.WarningSign;
    case "error":
...
const Alert = ({ className, children, intent = "error", title }: PropsType) => {
  const classes = clsx(styles.main, styles[intent], className);

  return (
    <div className={classes} role="alert">
      <Icon className={styles.icon} name={getIcon(intent)} />
